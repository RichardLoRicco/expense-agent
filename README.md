...
A personal expense management assistant built with the [Mastra](https://mastra.ai/) framework and Google Gemini 3 Flash. This agent helps you track spending, manage budgets, and gain insights into your financial habits using natural language.
